...
// modif variable avec condition
    ...
    if ($_POST['message']==""){
      ...
      $txt =  filter_var($_POST['message'], FILTER_SANITIZE_STRING);
      $corp = "Hello $gender, $lastname $firstname this email is send to you because we have receive an request from you about $reason
...
<html>
    ...
    <body lang="eng">
        <header id="header">
            <img  class="logo" src="img/hackers-poulette-logo.png" alt="logo">
        </header>
     <section class="col-10 mx-auto mb-3 sectionForm text-center">
       <h1 class="mt-3">Congratulation :</h1>
       ...
       <button type="button" class="btn btn-info mb-3"><a href="../index.php">Contact</a></button>
    </section>
